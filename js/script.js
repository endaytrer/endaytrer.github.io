window.onload = function () {
    ...
    switch (rand2) {
        case 0:
            frame.style.backgroundImage = 'url("../image/waterpaint.jpg")';
            titleBlank.classList.add("waterpaint");
            titleBlank.classList.remove("dawn");
            break;
        case 1:
            frame.style.backgroundImage = 'url("../image/leaves.jpg")';
            titleBlank.classList.add("leaves");
            titleBlank.classList.remove("dawn");
            break;
        default:
            // ???
            frame.style.backgroundImage = 'url("../image/midnight.jpg")';
